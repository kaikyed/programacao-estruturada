...
// Salve e leia múltiplos registros:

// Escreva um programa para cadastrar 3 pessoas (nome/idade), salvar no arquivo “pessoas.bin” e outro programa para ler e mostrar os 3 registros gravados.
